...
.container {
    ...
    padding-top: 50px; /* Add some space from the top if needed */
}
...
<div class="modern-navbar">
 ...
 --%>			</div>
	...
	<form action="editproductdetailspage" method="post">
		<div class="form-row">
		<div class="form-group col-md-6">
				<label for="productName">Id</label> <input type="tel"
            ...
            <select class="form-control" id="category" name="category">
                ...
                <option value="electronics" ${productdto.category == 'electronics' ? 'selected' : ''}>Electronics</option>
                <option value="clothing" ${productdto.category == 'clothing' ? 'selected' : ''}>Clothing</option>
                <option value="books" ${productdto.category == 'books' ? 'selected' : ''}>Books</option>
                <option value="furniture" ${productdto.category == 'furniture' ? 'selected' : ''}>Furniture</option>
                <option value="appliances" ${productdto.category == 'appliances' ? 'selected' : ''}>Appliances</option>
            </select>
        </div>
			<div class="form-group col-md-6">
        ...
        <select class="form-control" id="available" name="available">
            <option value="choose" ${productdto.available == 'choose' ? 'selected' : ''}>Select Available</option>
            <option value="yes" ${productdto.available == 'In Stock' ? 'selected' : ''}>In Stock</option>
            <option value="no" ${productdto.available == 'Outof Stock' ? 'selected' : ''}>Outof Stock</option>
        </select>
    </div>
