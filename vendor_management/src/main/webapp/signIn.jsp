...
body {
/* 	background-image: url('women.jpeg');
 */	background-size: cover;
	background-repeat: no-repeat;
	background-attachment: fixed;
}
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="signIn.jsp">SignIn/register</a></li>
...
function onEmail() {
	...
	if (emailRegex.test(emailValue)) {
		...
		xhttp.open("GET",
				"http://localhost:8081/vendor_management/loginEmail/"
		...
		xhttp.onload = function() {
			if (xhttp.status === 200) {
				...
				if (exists==="emailiNotExit") {
					document.getElementById("emailError").innerHTML = "Email id doesn't exist please register";
					document.getElementById("checkEmail").disabled = true;
				
					
				} 
				else if(exists==="under verification"){
					document.getElementById("emailError").innerHTML = " your account is under verification";
					document.getElementById("checkEmail").disabled = true;
...
function validateEmail() {
    ...
    $.ajax({
        url: 'http://localhost:8081/vendor_management/saveLoginOtp/' + userEmail,
        type: 'GET',
